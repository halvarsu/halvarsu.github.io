...
return cljs.core.merge.call(null,initial_state,p1__7119_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_7120 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_7121 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_7120);
var pos_7122 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_7120);
quil.core.scale.call(null,zoom_7121);

var tr__7042__auto___7123 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_7121) - cljs.core.first.call(null,pos_7122)),(((quil.core.height.call(null) / (2)) / zoom_7121) - cljs.core.second.call(null,pos_7122))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__7042__auto___7123);
