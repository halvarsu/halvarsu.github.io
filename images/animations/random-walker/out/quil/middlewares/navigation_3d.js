...
var vec__6615 = axis;
var a_x = cljs.core.nth.call(null,vec__6615,(0),null);
var a_y = cljs.core.nth.call(null,vec__6615,(1),null);
var a_z = cljs.core.nth.call(null,vec__6615,(2),null);
var vec__6616 = v;
var x = cljs.core.nth.call(null,vec__6616,(0),null);
var y = cljs.core.nth.call(null,vec__6616,(1),null);
var z = cljs.core.nth.call(null,vec__6616,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__6617,p__6618){
var vec__6621 = p__6617;
var u1 = cljs.core.nth.call(null,vec__6621,(0),null);
var u2 = cljs.core.nth.call(null,vec__6621,(1),null);
var u3 = cljs.core.nth.call(null,vec__6621,(2),null);
var vec__6622 = p__6618;
var v1 = cljs.core.nth.call(null,vec__6622,(0),null);
var v2 = cljs.core.nth.call(null,vec__6622,(1),null);
var v3 = cljs.core.nth.call(null,vec__6622,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__6623_SHARP_){
return (p1__6623_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__6624_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__6625_SHARP_,angle_lr),angle_ud);
...
var map__6632 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__6632__$1 = ((((!((map__6632 == null)))?((((map__6632.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6632.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6632):map__6632);
var up = cljs.core.get.call(null,map__6632__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__6632__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__6634 = cljs.core._EQ_;
var expr__6635 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__6634.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__6635))){
return straight;
} else {
if(cljs.core.truth_(pred__6634.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__6635))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__6634.call(null,quil.middlewares.navigation_3d.space,expr__6635))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__6634.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__6635))){
return up;
} else {
if(cljs.core.truth_(pred__6634.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__6635))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__6634.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__6635))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__6632,map__6632__$1,up,straight){
return (function (p1__6626_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__6626_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__6632,map__6632__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__6637_SHARP_);
});})(initial_state))
);
});
/**
...
var map__6643_6648 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__6643_6649__$1 = ((((!((map__6643_6648 == null)))?((((map__6643_6648.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6643_6648.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6643_6648):map__6643_6648);
var vec__6644_6650 = cljs.core.get.call(null,map__6643_6649__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_6651 = cljs.core.nth.call(null,vec__6644_6650,(0),null);
var c_y_6652 = cljs.core.nth.call(null,vec__6644_6650,(1),null);
var c_z_6653 = cljs.core.nth.call(null,vec__6644_6650,(2),null);
var vec__6645_6654 = cljs.core.get.call(null,map__6643_6649__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_6655 = cljs.core.nth.call(null,vec__6645_6654,(0),null);
var u_y_6656 = cljs.core.nth.call(null,vec__6645_6654,(1),null);
var u_z_6657 = cljs.core.nth.call(null,vec__6645_6654,(2),null);
var vec__6646_6658 = cljs.core.get.call(null,map__6643_6649__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_6659 = cljs.core.nth.call(null,vec__6646_6658,(0),null);
var p_y_6660 = cljs.core.nth.call(null,vec__6646_6658,(1),null);
var p_z_6661 = cljs.core.nth.call(null,vec__6646_6658,(2),null);
quil.core.camera.call(null,p_x_6659,p_y_6660,p_z_6661,(p_x_6659 + c_x_6651),(p_y_6660 + c_y_6652),(p_z_6661 + c_z_6653),u_x_6655,u_y_6656,u_z_6657);
