...
var or__4685__auto__ = cljs.core.last.call(null,cljs.core.sort.call(null,cljs.core.map.call(null,(function (p1__5871_SHARP_){
return p1__5871_SHARP_.length();
...
var args5872 = [];
var len__5743__auto___5875 = arguments.length;
var i__5744__auto___5876 = (0);
while(true){
if((i__5744__auto___5876 < len__5743__auto___5875)){
args5872.push((arguments[i__5744__auto___5876]));

var G__5877 = (i__5744__auto___5876 + (1));
i__5744__auto___5876 = G__5877;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args5872.length)].join('')));
...
return (function (p__5881){
var vec__5882 = p__5881;
var k = cljs.core.nth.call(null,vec__5882,(0),null);
var v = cljs.core.nth.call(null,vec__5882,(1),null);
var len = k.length();
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__5883_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__5883_SHARP_,cljs.core.symbol.call(null,[cljs.core.str("PConstants/"),cljs.core.str(quil.util.prepare_quil_name.call(null,p1__5883_SHARP_))].join(''))],null));
}),constants));
});
quil.util.prepare_quil_cljs_constants = (function quil$util$prepare_quil_cljs_constants(constants){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__5884_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__5884_SHARP_,cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Symbol("cljs.core","aget","cljs.core/aget",6345791,null)),cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Symbol("js","Processing.prototype.PConstants","js/Processing.prototype.PConstants",2034048972,null)),cljs.core._conj.call(null,cljs.core.List.EMPTY,quil.util.prepare_quil_name.call(null,p1__5884_SHARP_)))))],null));
}),constants));
});
...
var len__5743__auto___5890 = arguments.length;
var i__5744__auto___5891 = (0);
while(true){
if((i__5744__auto___5891 < len__5743__auto___5890)){
args__5750__auto__.push((arguments[i__5744__auto___5891]));

var G__5892 = (i__5744__auto___5891 + (1));
i__5744__auto___5891 = G__5892;
continue;
} else {
}
break;
...
return quil.util.generate_quil_constants.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__5751__auto__);
});
...
return cljs.core.sequence.call(null,cljs.core.seq.call(null,cljs.core.concat.call(null,cljs.core._conj.call(null,cljs.core.List.EMPTY,new cljs.core.Symbol(null,"do","do",1686842252,null)),cljs.core.map.call(null,(function (p1__5885_SHARP_){
return quil.util.make_quil_constant_map.call(null,target,cljs.core.first.call(null,p1__5885_SHARP_),cljs.core.second.call(null,p1__5885_SHARP_));
}),cljs.core.partition.call(null,(2),opts)))));
});

quil.util.generate_quil_constants.cljs$lang$maxFixedArity = (3);

quil.util.generate_quil_constants.cljs$lang$applyTo = (function (seq5886){
var G__5887 = cljs.core.first.call(null,seq5886);
var seq5886__$1 = cljs.core.next.call(null,seq5886);
var G__5888 = cljs.core.first.call(null,seq5886__$1);
var seq5886__$2 = cljs.core.next.call(null,seq5886__$1);
var G__5889 = cljs.core.first.call(null,seq5886__$2);
var seq5886__$3 = cljs.core.next.call(null,seq5886__$2);
return quil.util.generate_quil_constants.cljs$core$IFn$_invoke$arity$variadic(G__5887,G__5888,G__5889,seq5886__$3);
});
