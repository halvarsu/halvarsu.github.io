...
fin=6000; %Velg en frekvens litt (>500Hz lavere) under frekvensen maalt i ro
wp2=14; %Antall sample i hvert tidsvindu blir 2.^wp2

%Gjoer klar og samle inn data
...
filename = input('Hvilket filnavn vil du bruke for aa lagre dataene?','s');
